    ...
    <div class="relative z-10">
        ...
        <div class="relative w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 mx-auto mb-5 sm:mb-6 flex items-center justify-center">
            ...
            <div class="w-full h-full rounded-2xl sm:rounded-3xl bg-amber-50 border border-amber-200 text-amber-700 flex items-center justify-center shadow-xs">
                <i data-lucide="shield-alert" class="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 stroke-[1.5]"></i>
            </div>
        </div>
        ...
        <div class="flex flex-col xs:flex-row flex-wrap items-stretch xs:items-center justify-center gap-2.5 sm:gap-3 mt-6 sm:mt-7">
            ...
            <a href="{{ route('admin.login') }}" class="w-full xs:w-auto px-5 sm:px-6 py-2.5 sm:py-3 min-h-11 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-xs sm:text-sm transition-all duration-300 flex items-center justify-center gap-2 shadow-xs hover:-translate-y-0.5">
