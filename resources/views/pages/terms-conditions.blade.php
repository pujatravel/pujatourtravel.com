        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 sm:mb-12 border-b border-slate-200 pb-6 sm:pb-8">
                <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-100 text-slate-700 text-xs font-semibold border border-slate-200 mb-4 shadow-2xs">
                    ...
                    <span class="leading-snug">Perjanjian Resmi Jasa Perjalanan Wisata & Petualangan Alam</span>
                </div>
            ...
            <div class="grid lg:grid-cols-12 gap-10 items-start">
                ...
                <div class="lg:col-span-8 space-y-8">
                    ...
                    <!-- PASAL 10 -->
                    <article id="pasal-10" class="scroll-mt-24 sm:scroll-mt-28 bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-7 lg:p-8 shadow-xs border border-slate-200 space-y-4 text-sm leading-relaxed text-slate-700">
                        <header class="flex items-center gap-3 border-b border-slate-100 pb-4">
                            <div class="w-8 h-8 rounded-xl bg-slate-100 border border-slate-200 text-slate-800 font-display font-extrabold text-xs flex items-center justify-center shrink-0">
                                10
                            </div>
                    ...
                    <!-- PASAL 11 -->
                    <article id="pasal-11" class="scroll-mt-24 sm:scroll-mt-28 bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-7 lg:p-8 shadow-xs border border-slate-200 space-y-4 text-sm leading-relaxed text-slate-700">
                        <header class="flex items-center gap-3 border-b border-slate-100 pb-4">
                            <div class="w-8 h-8 rounded-xl bg-slate-100 border border-slate-200 text-slate-800 font-display font-extrabold text-xs flex items-center justify-center shrink-0">
                                11
                            </div>
                    ...
                    <!-- PASAL 12 -->
                    <article id="pasal-12" class="scroll-mt-24 sm:scroll-mt-28 bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-7 lg:p-8 shadow-xs border border-slate-200 space-y-5 text-sm leading-relaxed text-slate-700">
                        <header class="flex items-center gap-3 border-b border-slate-100 pb-4">
                            <div class="w-8 h-8 rounded-xl bg-slate-100 border border-slate-200 text-slate-800 font-display font-extrabold text-xs flex items-center justify-center shrink-0">
                                12
                            </div>
