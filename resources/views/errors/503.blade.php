...
<div class="relative bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-10 lg:p-12 shadow-soft border border-neutral-200 overflow-hidden text-center">
    ...
    <div class="relative z-10">
        <!-- Status Pill Badge -->
        <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-50 border border-amber-200/80 text-amber-900 text-xs font-bold uppercase tracking-wider mb-5 sm:mb-6 shadow-2xs">
        ...
        <div class="relative w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 mx-auto mb-5 sm:mb-6 flex items-center justify-center">
            <div class="absolute inset-0 rounded-2xl sm:rounded-3xl bg-amber-500/10 animate-ping opacity-30"></div>
            <div class="w-full h-full rounded-2xl sm:rounded-3xl bg-amber-50 border border-amber-200 text-amber-700 flex items-center justify-center shadow-xs">
                <i data-lucide="wrench" class="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 stroke-[1.5]"></i>
            </div>
        </div>
        ...
        <div class="mt-6 p-4 sm:p-5 rounded-2xl bg-emerald-50/80 border border-emerald-200/90 text-left max-w-md mx-auto shadow-2xs">
            <div class="flex items-start gap-3">
                <div class="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-emerald-600 text-white flex items-center justify-center shrink-0 shadow-2xs mt-0.5">
        ...
        <div class="flex flex-col xs:flex-row flex-wrap items-stretch xs:items-center justify-center gap-2.5 sm:gap-3 mt-6 sm:mt-7">
            ...
            <button onclick="window.location.reload()" class="w-full xs:w-auto px-5 sm:px-6 py-2.5 sm:py-3 min-h-11 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs sm:text-sm transition-all duration-300 flex items-center justify-center gap-2 shadow-xs hover:-translate-y-0.5 cursor-pointer">
