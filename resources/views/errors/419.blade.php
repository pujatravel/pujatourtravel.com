...
<div class="relative bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-10 lg:p-12 shadow-soft border border-neutral-200 overflow-hidden text-center">
    ...
    <div class="relative z-10">
        <!-- Status Pill Badge -->
        <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 border border-blue-200/80 text-blue-900 text-xs font-bold uppercase tracking-wider mb-5 sm:mb-6 shadow-2xs">
        ...
        <div class="relative w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 mx-auto mb-5 sm:mb-6 flex items-center justify-center">
            <div class="absolute inset-0 rounded-2xl sm:rounded-3xl bg-blue-500/10 animate-ping opacity-30"></div>
            <div class="w-full h-full rounded-2xl sm:rounded-3xl bg-blue-50 border border-blue-200 text-blue-700 flex items-center justify-center shadow-xs">
                <i data-lucide="history" class="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 stroke-[1.5]"></i>
            </div>
        </div>
